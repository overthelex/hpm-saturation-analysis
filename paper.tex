...
yields a verified penetration-safety envelope; and subset simulation certifies its rare-event
tail. The pieces compose into a pipeline that turns an engineering simulation into a provable,
adversarially-verified statement about a physical defense.
